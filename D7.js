...
function concatStrings(stringa1, stringa2) {
  const pre = stringa1.substring(0, 3);
  //console.log(pre);
  const post = stringa2.substring(stringa2.length - 3);
 // console.log(post);
  let concatStrings = pre.concat(post);
  //console.log(concatStrings);
  let upperString = concatStrings.toUpperCase();
  console.log(upperString);
}

concatStrings("Arianna", "Loreti")
...
function numeriRandom() {
  ...
  for (let index = 0; index < 10; index++) {
    ...
    arrayNumeri.push(result);
  }
  return arrayNumeri;
}

const risultato = numeriRandom();
...
const numbers = [25, 72, 48, 12, 91]
const filteredArray = numbers.filter(function(elemento) {
return elemento % 2 === 0
}
)

console.log("I numeri pari sono:", filteredArray)
